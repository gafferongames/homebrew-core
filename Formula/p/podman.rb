class Podman < Formula
  ...
  test do
    ...
    if OS.mac?
      ...
      # by default
      configdir = shell_output("#{bin}/podman-remote machine inspect homebrew-testvm --format {{.ConfigDir.Path}}")
      assert_equal testpath/".config/containers/podman/machine/applehv", configdir
